...
class RNInCallManager: NSObject, AVAudioPlayerDelegate {
    ...
    @objc func start(_ media: String, auto: Bool, ringbackUriType: String) -> Void {
        ...
        self.audioSessionSetCategory(self.incallAudioCategory, [.defaultToSpeaker, .allowBluetoothA2DP, .allowBluetooth], #function)
//        self.audioSessionSetCategory(self.incallAudioCategory, nil, #function)
    ...
    func isWiredHeadsetPluggedIn() -> Bool {
        ...
        return self.checkAudioRoute([AVAudioSessionPortHeadphones,AVAudioSessionPortBluetoothLE, AVAudioSessionPortBluetoothA2DP], "output") || self.checkAudioRoute([AVAudioSessionPortHeadsetMic,AVAudioSessionPortBluetoothLE, AVAudioSessionPortBluetoothA2DP], "input")
    }
